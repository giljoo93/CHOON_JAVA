...
public class Library {
	...
	public static void main(String[] args) throws IOException {
		...
		while (true) {
			Tool.clearScreen();
			System.out.println(basic.status != null ? "System : " + basic.status : "");
...
//	정렬 로직------------------------------------------------------------------------------------------	
	...
	public void sort(int KoS) {
		...
		case 1:
			...
			this.status = (KoS == 2 ? "책제목으로 오름차순 정렬을 완료했습니다."
		...
		case 2:
			...
			this.status = (KoS == 2 ? "책제목으로 내림차순 정렬을 완료했습니다."
...
//	DB관리 로직---------------------------------------------------------------------------------------	
	...
	public void readDB() throws IOException {
		...
		for (String Line = fr.readLine(); Line != null; Line = fr.readLine()) {
			...
			temp = Line.split("/");
			LocalDate tempRegDate = LocalDate.parse(temp[3]);
			tempDB = new Book(temp[0], temp[1], temp[2], tempRegDate, temp[4], temp[5], temp[6]);
			bookList[idx] = tempDB;
			idx++;
		}
		fr.close();
